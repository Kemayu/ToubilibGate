...
return function (App $app): App {
    ...
    $app->get('/rdvs/{id}', GateAction::class);
    $app->post('/rdvs', GateAction::class);
    $app->delete('/rdvs/{id}', GateAction::class);
    $app->patch('/rdvs/{id}', GateAction::class);
    $app->get('/praticiens/{praticienId}/creneaux', GateAction::class);
    
    // Routes pour les patients (vers app.rdv)
    $app->get('/patients', GateAction::class);
    $app->get('/patients/{id}', GateAction::class);
    $app->get('/patients/{patientId}/consultations', GateAction::class);
    
    // Routes pour l'authentification (vers app.rdv)
